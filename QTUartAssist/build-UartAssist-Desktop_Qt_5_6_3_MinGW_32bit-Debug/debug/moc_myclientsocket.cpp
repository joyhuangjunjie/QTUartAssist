...
#include "../../UartAssist/TCPSERVER/myclientsocket.h"
...
QT_MOC_LITERAL(1, 15, 14), // "ClientReadData"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 8), // "clientID"
QT_MOC_LITERAL(4, 40, 2), // "IP"
QT_MOC_LITERAL(5, 43, 4), // "Port"
QT_MOC_LITERAL(6, 48, 4), // "data"
QT_MOC_LITERAL(7, 53, 16), // "ClientDisConnect"
QT_MOC_LITERAL(8, 70, 8), // "ReadData"
QT_MOC_LITERAL(9, 79, 10) // "DisConnect"

    },
    "myClientSocket\0ClientReadData\0\0clientID\0"
...
void myClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (myClientSocket::*_t)(int , QString , int , QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myClientSocket::ClientReadData)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (myClientSocket::*_t)(int , QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myClientSocket::ClientDisConnect)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject myClientSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_myClientSocket.data,
      qt_meta_data_myClientSocket,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
