...
#include "../TCPSERVER/myclientsocket.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myClientSocket_t, stringdata) + ofs \
...
const QMetaObject myClientSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_myClientSocket.data,
      qt_meta_data_myClientSocket,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myClientSocket.stringdata))
